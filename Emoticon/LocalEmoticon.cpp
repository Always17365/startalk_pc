...
void LocalEmoticon::initUi()
{
    ...
    connect(_pLocalEmoLst, &QListWidget::customContextMenuRequested, this, [this](const QPoint & pos)
    {
...
void LocalEmoticon::initCollection(const StEmoticon &emo)
{
    ...
    connect(_mapEmoView[DEM_COLLECTION], &QTableWidget::customContextMenuRequested, this, [menu](const QPoint &)
    {
