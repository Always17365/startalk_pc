...
#ifndef STALK_V2_STYLEDEFINE_H
#define STALK_V2_STYLEDEFINE_H
...
class STALK_UTIL_EXPORT StyleDefine
{
public:
...
public:
    ...
    inline void setGroupCardGroupMemberNormalColor(const QColor
                                                   &color) {_group_card_group_member_normal_color = color;}
    inline void setGroupManagerNormalColor(const QColor
                                           &color) {_group_manager_normal_color = color; }
    inline void setGroupManagerNormalFontColor(const QColor
                                               &color) {_group_manager_normal_font_color = color; }
    inline void setTitleSearchNormalColor(const QColor
                                          &color) {_title_search_normal_color = color;}
    inline void setTitleSearchSelectColor(const QColor
                                          &color) {_title_search_select_color = color;}
    inline void setQuoteBlockBackgroundColor(const QColor
                                             &color) {_quote_block_background_color = color;}
...
class QPainter;
namespace st {
void STALK_UTIL_EXPORT setPainterFont(QPainter *painter, int level,
                                      int defaultSize = 13);
}
#endif //STALK_V2_STYLEDEFINE_H
