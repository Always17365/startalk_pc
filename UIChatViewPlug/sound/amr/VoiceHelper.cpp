...
bool VoiceHelper::amrFileToWavBuffer(const char *szAmrFileName,
                                     QByteArray &arrWavData)
{
    char header[6];
    int n;
    FILE *in;
...
bool VoiceHelper::amrBufferToWavBuffer(unsigned char *inBuffer, int inBufferLen,
                                       QByteArray *arrWavData)
{
    void *amr;
    void *amrDecoder;
...
bool VoiceHelper::WavBufferToAmrFile(const char *pArrWavData, int wavDatalen,
                                     const char *szAmrFileName)
{
    return true;
}
bool VoiceHelper::WavFileToAmrFile(const char *szWavFileName,
                                   const char *szAmrFileName)
{
...
bool VoiceHelper::WavFileToAmrBuffer(const char *szWavFileName,
                                     QByteArray &arrAmrData)
{
    enum Mode mode = MR122;
    const char *setMode = "12200";
    int ch, dtx = 0;
