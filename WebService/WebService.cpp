...
//    setMoverAble(true, titleFrm);
    ...
    connect(_pCloseBtn, &QToolButton::clicked, this, [this]()
    {
        setVisible(false);
    });
    connect(_webView->getWebView(), &QWebEngineView::titleChanged, this, [this](const QString & title)
    {
    ...
    connect(_pCopyUrlBtn, &QToolButton::clicked, this, [this]()
    {
        if(_webView)
        {
    ...
    connect(_pJumpToBrowserBtn, &QToolButton::clicked, this, [this]()
    {
    ...
    connect(_pAddressEdit, &QLineEdit::returnPressed, this,  [this]()
    {
    ...
    connect(_webView->getWebView(), &QWebEngineView::urlChanged, this, [this](const QUrl & url)
    {
