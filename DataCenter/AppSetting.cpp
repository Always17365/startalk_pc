...
void AppSetting::initAppSetting(const std::string &setting)
{
    ...
    if (obj != nullptr) {
        ...
        _newMsgAudioNotify = Json::get<bool>(obj, "NEWMSGAUDIO", _newMsgAudioNotify);
        _newMsgAudioPath = Json::get<std::string>(obj, "NEWMSGAUDIOPATH",
                                                  _newMsgAudioPath);
        _newMsgTipWindowNotify = Json::get<bool>(obj, "NEWMSGTIPWINDOW",
                                                 _newMsgTipWindowNotify);
        _screenshotKey = Json::get<std::string>(obj, "SCREENSHOT", _screenshotKey);
        _wakeWndKey = Json::get<std::string>(obj, "WAKEWND", _wakeWndKey);
        _openOaWithAppBrowser = Json::get<bool>(obj, "OPENOAWITHAPPBROWSER",
                                                _openOaWithAppBrowser);
        _screentShotHideWndFlag = Json::get<bool>(obj, "SCREENTSHOTHIDEWNDFLAG",
                                                  _screentShotHideWndFlag);
        _showSendMessageBtn = Json::get<bool>(obj, "SHOWSENDMESSAGEBTN",
                                              _showSendMessageBtn);
