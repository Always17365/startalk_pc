...
{
public:
    static bool SendLoginMessage(const std::string &userName,
...
//
class LoginPanel;
class UILoginMsgListener : public EventHandler<LoginSuccessMessage>,
    ...
    , public EventHandler<LoginErrMessage>,
