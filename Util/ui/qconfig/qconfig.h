...
bool STALK_UTIL_EXPORT loadConfig(const QString &xmlPath, bool encrypt, StConfig *config);
bool STALK_UTIL_EXPORT saveConfig(const QString &xmlPath, bool encrypt, const StConfig *config);
}
}
