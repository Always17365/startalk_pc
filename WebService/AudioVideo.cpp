    ...
    , isGroupVideo(false)
{
    ...
    connect(_webView, &WebView::sgFullScreen, this,  [this]()
    {
    ...
    connect(_webView, &WebView::sgLoadFinished, this,  [this]()
    {
        if(isGroupVideo)
        {
//            _webView->excuteJs("qtReady()");
    ...
    connect(_webView, &WebView::closeVideo, this, [this]()
    {
        this->close();
    });
    ...
    connect(obj, &WebJsObj::sgCloseRtcWindow, this, [this](const QString & id, long long occupied_time)
    {
...
void AudioVideoManager::start2Talk_old(const QString &json, const std::string &peerId, bool isVideo, bool isCall)
{
    ...
    pAudioVideo->show();
    connect(pAudioVideo, &AudioVideo::sgClose2AudioVideo, this, [this, key, pAudioVideo, peerId](long long occupied_time)
    {
    ...
    connect(pAudioVideo->obj, &WebJsObj::sgSendSignal, this, [this, pAudioVideo, peerId](const QString & json, const QString & id)
    {
...
void AudioVideoManager::start2Talk(const std::string &caller, const std::string &callee)
{
    ...
    pAudioVideo->activateWindow();
    pAudioVideo->show();
    connect(pAudioVideo, &AudioVideo::sgClose2AudioVideo, this, [this, key, pAudioVideo](long long)
    {
        _2Talks.remove(key);
        pAudioVideo->deleteLater();
    });
...
void AudioVideoManager::startGroupTalk(const QString &id, const QString &name)
{
    ...
    pAudioVideo->activateWindow();
    connect(pAudioVideo, &AudioVideo::closeAudioVideo, this, [this, id, pAudioVideo]()
    {
