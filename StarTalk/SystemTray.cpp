    ...
    : QObject(mainWnd), _pMainWindow(mainWnd), _timerCount(0)
{
    ...
    connect(_popWnd, &SystemTrayPopWnd::sgJumtoSession, this, [this](const StSessionInfo &)
    {
    ...
    connect(_popWnd, &SystemTrayPopWnd::sgStartTimer, this, [this]()
    {
#ifndef Q_OS_MAC
    ...
    connect(showWmdAct, &QAction::triggered, this, [this]()
    {
        stopTimer();
        _pMainWindow->wakeUpWindow();
    });
    connect(autoLoginAct, &QAction::triggered, this, [this, autoLoginAct]()
    {
        stopTimer();
